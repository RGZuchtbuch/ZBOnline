...
<Modal class=''>
    <form class='w-96 flex flex-col self-center rounded' on:submit|preventDefault={onSubmit}>
        ...
        <Form class='flex flex-col gap-4 rounded-b bg-gray-200 gap-4 p-4' on:submit={onSubmit}>
