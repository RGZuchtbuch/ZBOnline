...
class PostPair extends Route
{
    ...
    public function process(Request $request, array $args) : mixed
    {
        if ( $args['id'] == 0 ){
            ...
            $id = Queries\Pair::create($pair['breederId'], $pair['name'], $pair['year'], $pair['group'], $pair['breed']['sectionId'], $pair['breed']['breedId'], $pair['breed']['colorId'], $pair['paired'], $pair['notes'] );
