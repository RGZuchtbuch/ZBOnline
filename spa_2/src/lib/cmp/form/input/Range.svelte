<script>
    ...
    let { class:classname='', disabled=false, element=$bindable(), error='!', label=null, max=null, min=null, name=null, step=1, title=null, validator=null, value=$bindable() } = $props();
