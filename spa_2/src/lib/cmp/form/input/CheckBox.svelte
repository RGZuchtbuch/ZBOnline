<script>
	...
	let { class:classname='', disabled=false, element=$bindable(), error='Fehler', label=null, name=null, onchange=null, placeholder=null, title=null, validator=null, value=$bindable() } = $props();
