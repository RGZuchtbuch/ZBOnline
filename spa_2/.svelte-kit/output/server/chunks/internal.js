                        ...
                        children: ($$payload5) => {
                          if (constructors[5]) {
                            ...
                            Pyramid_4($$payload5, {
                              ...
                              children: ($$payload6) => {
                                $$payload6.out.push(`<!---->`);
                                Pyramid_5($$payload6, { data: data_5, form, params: page.params });
                                $$payload6.out.push(`<!---->`);
                              },
                              $$slots: { default: true }
                            });
                            ...
                            const Pyramid_4 = constructors[4];
                            $$payload5.out.push(`<!---->`);
                            Pyramid_4($$payload5, { data: data_4, form, params: page.params });
                            $$payload5.out.push(`<!---->`);
                          }
                          $$payload5.out.push(`<!--]-->`);
                        },
...
const options = {
  ...
  templates: {
	...
	<body class='flex flex-row justify-center'>\r
		<div class='grow bg-[url("/assets/bg_bdrg_zuchtbuch.png")] bg-top bg-contain'></div>\r
		<div class='relative h-full w-full lg:w-256 m-auto flex flex-col screen:border rounded bg-[url("/assets/bg_bdrg_zuchtbuch.png")] bg-top bg-contain'>` + body + `</div>\r
		<div class='grow bg-[url("/assets/bg_bdrg_zuchtbuch.png")] bg-top bg-contain'></div>\r
	</body>\r
</html>\r
`,
