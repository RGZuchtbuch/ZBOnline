	...
	public static function forChart(int $districtId, int $year, ? int $sectionId, ? int $breedId, ? int $colorId, ? string $group ) : ? array {
		...
		$stmt = Query::prepare('
            SELECT count(*) AS results, 
                ...
                :sectionId  AS sectionId, :breedId AS breedId, :colorId AS colorId, layers,
            ...
            FROM (
                ...
                SELECT 
                    ...
                    SUM( IF( subsection.layers = 0 AND pairs > 0 AND broodHatched IS NOT NULL, breeders, 0 )) AS broodPigeonBreeders,
